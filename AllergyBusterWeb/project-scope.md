...
Build a website to support the mobile app (iOS \& Android) that allows a person to scan, take a picture, or enter search criteria to retrieve allergy information quickly and reliably.
...
* Provide landing page for users to view information about the mobile app.
* Allow users to add information supporting the restaurant allergen schema
* Show how to videos on Product Scanning, Ingredient Labels, Product Search and Ingredient Search.
...
re\_UxFgWiQf\_3NC9CRFzcsPP8sjyGSnKA4hD
